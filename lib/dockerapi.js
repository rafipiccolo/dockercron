...
async function info(params) {
    const { statusCode, body } = await dockerApi(params.host, 'GET', '/v1.41/info', null, params.timeout);
...
async function getTask(params) {
    const { statusCode, body } = await dockerApi(params.host, 'GET', `/v1.41/tasks/${params.id}`, null, params.timeout);
...
async function listNodes(params) {
    const { statusCode, body } = await dockerApi(params.host, 'GET', '/v1.41/nodes', null, params.timeout);
...
async function getNode(params) {
    const { statusCode, body } = await dockerApi(params.host, 'GET', `/v1.41/nodes/${params.id}`, null, params.timeout);
...
async function listServices(params) {
    const { statusCode, body } = await dockerApi(params.host, 'GET', '/v1.41/services', null, params.timeout);
...
async function listContainers(params) {
    const { statusCode, body } = await dockerApi(params.host, 'GET', '/v1.41/containers/json', null, params.timeout);
...
async function getService(params) {
    const { statusCode, body } = await dockerApi(params.host, 'GET', `/v1.41/services/${params.id}`, null, params.timeout);
...
async function getContainer(params) {
    const { statusCode, body } = await dockerApi(params.host, 'GET', `/v1.41/containers/${params.id}/json`, null, params.timeout);
...
async function getExec(params) {
    const { statusCode, body } = await dockerApi(params.host, 'GET', `/v1.41/exec/${params.id}/json`, null, params.timeout);
